...
$rc1 = $s->addTeacher(1,"Christine","?","?",300);
...
#add a teacher - expected $rc = 0
$rc4 = $s->addStudent(1,"Marni","Falkvard","Joensen");
#try to add same student - expected $rc = -1
$rc5 = $s->addStudent(1,"Marni","Falkvard","Joensen");
#remove student - expected $rc = 0
$rc6 = $s->removeStudent(1);
#remove not existing student - expected $rc = -1
$rc7 =$s->removeStudent(2);
